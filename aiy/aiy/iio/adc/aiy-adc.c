...
static const struct aiy_adc_pin_config aiy_adc_pin_configs[] = {
	[AIY_ADC_CHAN_V3P3] = { AIY_REG_ADC_VALUE_PA02, AIY_GPIO_PIN_PA02_OFFSET },
	[AIY_ADC_CHAN_V1P8] = { AIY_REG_ADC_VALUE_PA03, AIY_GPIO_PIN_PA03_OFFSET },
	[AIY_ADC_CHAN_V1P2] = { AIY_REG_ADC_VALUE_PA06, AIY_GPIO_PIN_PA06_OFFSET },
	[AIY_ADC_CHAN_V0P9] = { AIY_REG_ADC_VALUE_PA07, AIY_GPIO_PIN_PA07_OFFSET },
	[AIY_ADC_CHAN_USER0] = { AIY_REG_ADC_VALUE_PA04, AIY_GPIO_PIN_PA04_OFFSET },
	[AIY_ADC_CHAN_USER1] = { AIY_REG_ADC_VALUE_PA05, AIY_GPIO_PIN_PA05_OFFSET },
	[AIY_ADC_CHAN_USER2] = { AIY_REG_ADC_VALUE_PA10, AIY_GPIO_PIN_PA10_OFFSET },
	[AIY_ADC_CHAN_USER3] = { AIY_REG_ADC_VALUE_PA11, AIY_GPIO_PIN_PA11_OFFSET },
};
			    ...
			    int *val2, long mask)
{
	...
	/* aiy_io_i2c 構造体は親デバイスの drvdata にセットされている前提 */
...
/* 1チャネルにつき RAW と PROCESSED の両方の情報を提供する */
#define AIY_ADC_CHANNEL(_ch, _address, _name)                          \
	{                                                           \
		.type = IIO_VOLTAGE,                                \
		.indexed = 1,                                       \
		.channel = (_ch),                                   \
...
static const struct iio_chan_spec aiy_adc_channels[] = {
	/* User channels */
	AIY_ADC_CHANNEL(0, AIY_ADC_CHAN_USER0, "user0"),
	AIY_ADC_CHANNEL(1, AIY_ADC_CHAN_USER1, "user1"),
	AIY_ADC_CHANNEL(2, AIY_ADC_CHAN_USER2, "user2"),
	AIY_ADC_CHANNEL(3, AIY_ADC_CHAN_USER3, "user3"),
	/* Power rails */
	AIY_ADC_CHANNEL(4, AIY_ADC_CHAN_V3P3, "v3p3"),
	AIY_ADC_CHANNEL(5, AIY_ADC_CHAN_V1P8, "v1p8"),
	AIY_ADC_CHANNEL(6, AIY_ADC_CHAN_V1P2, "v1p2"),
	AIY_ADC_CHANNEL(7, AIY_ADC_CHAN_V0P9, "v0p9"),
};
